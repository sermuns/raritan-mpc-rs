...
public class RfbVMShareTableMsgV01_21
extends ProtocolMessage {
    ...
    public void read(MonitoringDataInputStream monitoringDataInputStream, boolean bl) throws IOException {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            int n4 = monitoringDataInputStream.readUnsignedByte();
            ...
            byArray = new byte[n4];
            monitoringDataInputStream.readFully(byArray, 0, n4);
            String string3 = new String(byArray);
            this.vmShareList.add(new VMMountRequestResponse(string2, string3));
        }
    }
}
