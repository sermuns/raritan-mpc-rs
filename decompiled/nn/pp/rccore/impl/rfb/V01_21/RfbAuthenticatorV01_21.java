...
public class RfbAuthenticatorV01_21 {
    ...
    public RfbAuthenticatorV01_21(RfbHandler rfbHandler, Logger logger) {
    ...
    public void negotiateAuthentication() throws IOException, RCException {
        if ((this.authCaps & 4) != 0 && this.username != null && this.password != null) {
            ...
            try {
                ...
                this.logger.log(Level.WARNING, T._("MD5 not available, using plain authentication."));
                this.authMethod = 0;
            }
        } else if ((this.authCaps & 2) != 0 && this.username != null && this.password != null) {
    ...
    public void processChallenge(byte[] byArray) throws IOException, RCException {
        switch (this.authMethod) {
            ...
            case 2: {
                ...
                String string = this.rfbHandler.getChallengeResponse(byArray3, "MD5");
                this.rfbHandler.writeChallengeResponse(string + '\u0000');
                break;
            }
            case 3: {
