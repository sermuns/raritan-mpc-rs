...
import nn.pp.rccore.impl.rfb.V01_29.RfbAssociatedTagMsgV01_29;
import nn.pp.rccore.impl.rfb.V01_29.RfbClientInitMsgV01_29;

public class RfbHandlerV01_29
extends RfbHandler {
    ...
    private RfbClientInitMsgV01_29 clientInitMsg;
    ...
    private RfbAssociatedTagMsgV01_29 associatedTagMsg;
    ...
    protected void loadPdus() {
        ...
        this.clientInitMsg = new RfbClientInitMsgV01_29();
        ...
        this.associatedTagMsg = new RfbAssociatedTagMsgV01_29();
    }
    ...
    protected void processInitialHandshake(int n) throws IOException, RCException {
        switch (n) {
            ...
            case 7: {
                ...
                if (this.getClientSessionInitProps().containsKey((Object)IMultiMonitorTargetSupport.ClientSessionInitProperties.MULTI_MONITOR_ASSOCIATION_ID)) {
                    this.writeAssociatedTagMsg(this.getClientSessionInitProps().get((Object)IMultiMonitorTargetSupport.ClientSessionInitProperties.MULTI_MONITOR_ASSOCIATION_ID));
                }
    ...
    protected VMConfigInfo readVirtualMediaConfig() throws IOException, RCException {
        ...
        int n = this.vmConfig.validate_28();
        if (n < 0) {
    ...
    protected synchronized void writeClientInitMsg(String string) throws IOException, RCException {
        this.clientInitMsg.setClientSessionInitProps(this.getClientSessionInitProps());
    ...
    protected void writeAssociatedTagMsg(String string) throws IOException {
        this.associatedTagMsg.write(this.os, string);
    }
    ...
    public void dispose() {
        ...
        if (this.associatedTagMsg != null) {
            this.associatedTagMsg = null;
        }
        super.dispose();
    }
}
