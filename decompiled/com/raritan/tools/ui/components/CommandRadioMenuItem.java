...
public class CommandRadioMenuItem
...
MultyObserverComponentInterface {
    ...
    public CommandRadioMenuItem(ScreenContext screenContext) {
        this.scrContext = screenContext;
        this.command = new DummyCommand(this.scrContext);
    }

    public CommandRadioMenuItem(String string, ScreenContext screenContext) {
        super(string);
        this.scrContext = screenContext;
        this.command = new DummyCommand(this.scrContext);
    }

    public CommandRadioMenuItem(String string, boolean bl, ScreenContext screenContext) {
        super(string, bl);
        this.scrContext = screenContext;
        this.command = new DummyCommand(this.scrContext);
    }

    public CommandRadioMenuItem(Action action, ScreenContext screenContext) {
        super(action);
        this.scrContext = screenContext;
        this.command = new DummyCommand(this.scrContext);
    }

    public CommandRadioMenuItem(Icon icon, ScreenContext screenContext) {
        super(icon);
        this.scrContext = screenContext;
        this.command = new DummyCommand(this.scrContext);
    }

    public CommandRadioMenuItem(String string, Icon icon, ScreenContext screenContext) {
        super(string, icon);
        this.scrContext = screenContext;
        this.command = new DummyCommand(this.scrContext);
    }

    public CommandRadioMenuItem(String string, Icon icon, boolean bl, ScreenContext screenContext) {
