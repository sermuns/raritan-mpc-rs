...
public class SpringUtilities {
    ...
    public static void makeGrid(Container container, int n, int n2, int n3, int n4, int n5, int n6) {
        ...
        for (int i = 0; i < n8; ++i) {
            constraints = springLayout.getConstraints(container.getComponent(i));
            if (i % n2 == 0) {
    ...
    public static void makeCompactGrid(Container container, int n, int n2, int n3, int n4, int n5, int n6) {
        ...
        for (int i = 0; i < n2; ++i) {
            ...
            for (n7 = 0; n7 < n; ++n7) {
                constraints = SpringUtilities.getConstraintsForCell(n7, i, container, n2);
        ...
        for (int i = 0; i < n; ++i) {
            ...
            for (n8 = 0; n8 < n2; ++n8) {
                constraints = SpringUtilities.getConstraintsForCell(i, n8, container, n2);
                constraints.setY(spring3);
                constraints.setHeight(spring4);
            }
            spring3 = Spring.sum(spring3, Spring.sum(spring4, Spring.constant(n6)));
        }
        SpringLayout.Constraints constraints2 = springLayout.getConstraints(container);
        constraints2.setConstraint("South", spring3);
        constraints2.setConstraint("East", spring);
    }
}
