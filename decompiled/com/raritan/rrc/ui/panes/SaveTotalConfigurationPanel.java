...
import com.raritan.rrc.ui.commands.DoSaveTotalConfigurationCommand;
...
public class SaveTotalConfigurationPanel
extends FileBrowserPanel {
    private static final long serialVersionUID = -5219254633560134388L;

    public SaveTotalConfigurationPanel(boolean bl, ScreenContext screenContext) {
        super(bl, screenContext);
        this.setTitle(this.bundle.getString("filebrowser.save.totalconfig.title"));
    }
    ...
    public void makeLayout() {
        ...
        this.chooser.setCommand(new DoSaveTotalConfigurationCommand(this.scrContext));
