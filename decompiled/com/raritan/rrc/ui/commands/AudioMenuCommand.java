...
public class AudioMenuCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "audioMenuCommand";

    public AudioMenuCommand(ScreenContext screenContext) {
        super(screenContext);
    }
