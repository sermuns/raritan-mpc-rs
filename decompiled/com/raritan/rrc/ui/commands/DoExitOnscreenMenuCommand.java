...
public class DoExitOnscreenMenuCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doExitOnscreenMenuCommand";

    public DoExitOnscreenMenuCommand(ScreenContext screenContext) {
        super(screenContext);
    }
