...
public class DoCalibrateColorCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doCalibrateColorCommand";

    public DoCalibrateColorCommand(ScreenContext screenContext) {
        super(screenContext);
    }
