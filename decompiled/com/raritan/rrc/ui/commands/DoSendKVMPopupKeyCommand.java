...
public class DoSendKVMPopupKeyCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doSendKVMPopupKeyCommand";

    public DoSendKVMPopupKeyCommand(ScreenContext screenContext) {
        super(screenContext);
    }
