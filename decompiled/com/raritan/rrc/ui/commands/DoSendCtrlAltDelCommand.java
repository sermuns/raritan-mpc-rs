...
public class DoSendCtrlAltDelCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doSendCtrlAltDelCommand";

    public DoSendCtrlAltDelCommand(ScreenContext screenContext) {
        super(screenContext);
    }
