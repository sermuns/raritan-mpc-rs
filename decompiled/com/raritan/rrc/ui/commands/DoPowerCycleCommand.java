...
public class DoPowerCycleCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doPowerCycleCommand";

    public DoPowerCycleCommand(ScreenContext screenContext) {
        super(screenContext);
    }
    ...
    public void doExecute(CommandResult commandResult) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            String string = port.getDeviceConnector().databaseRequest("<Power><Cycle>" + port.getStripTargetDeviceId() + "</Cycle></Power>", 60000);
            boolean bl = false;
            if (string != null) {
                    ...
                    if (nodeList.getLength() == 1) {
                        ...
                        try {
                            ...
                            if (n < 0) {
                                ...
                                String string3 = this.getBundle().getString("POWER_OPERATION_CYCLE_ERR");
                                ...
                                RRCLogger.log(300, 1, "Powercycle operation failed. Error code : " + n);
                                return;
                            }
                        }
    ...
    private void setFailureResult(CommandResult commandResult, String string) {
        commandResult.setIsSuccess(false);
        String string2 = this.getBundle().getString("POWER_OPERATION_CYCLE_ERR");
