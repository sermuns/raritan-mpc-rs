...
public class DoAutoSenseCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doAutoSenseCommand";

    public DoAutoSenseCommand(ScreenContext screenContext) {
        super(screenContext);
    }
    ...
    public CommandResult execute() {
        ...
        if (port != null && port.isConnected() && port.getView() != null && (deviceView = port.getView()) != null) {
            deviceView.autoSenseVideo();
        }
