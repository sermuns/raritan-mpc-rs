...
public class ShowLoadConfigurationCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "showLoadDeviceConfigurationCommand";

    public ShowLoadConfigurationCommand(RRCScreenContext rRCScreenContext) {
