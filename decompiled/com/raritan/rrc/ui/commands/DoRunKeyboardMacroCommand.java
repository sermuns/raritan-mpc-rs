...
public class DoRunKeyboardMacroCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doRunKeyboardMacroCommand";

    public DoRunKeyboardMacroCommand(ScreenContext screenContext) {
        super(screenContext);
    }
    ...
    public CommandResult execute() {
        ...
        if (deviceView != null) {
            ...
            commandResult.setIsSuccess(deviceView.macroMenuActionPerformed(keyboardMacrosPreferences.getMacroSequence()));
        } else {
            RRCLogger.log(100, 1, "View is null in DoRunKeyboardMacroCommand");
        }
