...
public class DoRefreshNavigatorCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doRefreshNavigatorCommand";

    public DoRefreshNavigatorCommand(ScreenContext screenContext) {
        super(screenContext);
    }
