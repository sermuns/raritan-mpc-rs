...
public class ShowAddProfileCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "showAddProfileCommand";

    public ShowAddProfileCommand(ScreenContext screenContext) {
        super(screenContext);
    }
    ...
    public boolean isExecutable() {
        ...
        if (arrayList != null && arrayList.size() > 0 && (device = (Device)arrayList.get(0)) instanceof IPReach) {
            return !device.isProfiled() && !device.isConnected();
        }
        return false;
    }
}
