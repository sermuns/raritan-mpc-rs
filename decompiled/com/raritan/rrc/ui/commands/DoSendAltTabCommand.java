...
public class DoSendAltTabCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doSendAltTabCommand";

    public DoSendAltTabCommand(ScreenContext screenContext) {
        super(screenContext);
    }
