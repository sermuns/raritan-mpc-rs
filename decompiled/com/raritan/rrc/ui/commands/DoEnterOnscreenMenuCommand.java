...
public class DoEnterOnscreenMenuCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doEnterOnscreenMenuCommand";

    public DoEnterOnscreenMenuCommand(ScreenContext screenContext) {
        super(screenContext);
    }
