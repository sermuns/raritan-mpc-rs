...
public class DoSelectAllTextCommand
extends AbstractCommand {
    public static final String COMMAND_KEY = "doSelectAllTextCommand";

    public DoSelectAllTextCommand(ScreenContext screenContext) {
        super(screenContext);
    }
    ...
    public CommandResult execute() {
        ...
        if (port.isConnected()) {
            serialView.getSerialTerminal().doSelectAll();
        }
