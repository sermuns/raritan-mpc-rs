...
public class TRCMD_STOP_VIDEO_STREAM_DATA
extends TRCOMMAND {
    private int deviceID_OFFSET = 4;
    public static final short CMD_LEN = 5;

    public TRCMD_STOP_VIDEO_STREAM_DATA(byte[] byArray) {
        super(byArray);
    }

    public TRCMD_STOP_VIDEO_STREAM_DATA() {
        super((short)5);
    }

    public TRCMD_STOP_VIDEO_STREAM_DATA(short s) {
        super(s);
    }
