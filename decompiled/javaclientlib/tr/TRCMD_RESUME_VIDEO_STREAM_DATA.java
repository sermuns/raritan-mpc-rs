...
public class TRCMD_RESUME_VIDEO_STREAM_DATA
extends TRCOMMAND {
    private static final int flags_OFFSET = 4;
    private static final int deviceID_OFFSET = 8;
    public static final short CMD_LEN = 9;

    public TRCMD_RESUME_VIDEO_STREAM_DATA(byte[] byArray) {
        super(byArray);
        this.setCommand((byte)63);
        this.setCmdLength((short)9);
        this.setDeviceID(255);
    }

    public TRCMD_RESUME_VIDEO_STREAM_DATA(short s) {
        super(s);
        this.setCommand((byte)63);
        this.setCmdLength((short)9);
        this.setDeviceID(255);
    ...
    public TRCMD_RESUME_VIDEO_STREAM_DATA() {
        super((short)9);
        this.setCommand((byte)63);
        this.setCmdLength((short)9);
        this.setDeviceID(255);
