...
public class TRCMD_GET_VIDEO_PARAMS_DATA
extends TRCOMMAND {
    private int deviceID_OFFSET = 4;
    public static final short CMD_LEN = 5;

    public TRCMD_GET_VIDEO_PARAMS_DATA(byte[] byArray) {
        super(byArray);
    }

    public TRCMD_GET_VIDEO_PARAMS_DATA() {
        super((short)5);
    }

    public TRCMD_GET_VIDEO_PARAMS_DATA(short s) {
        super(s);
    }
