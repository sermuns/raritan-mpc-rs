...
/// Standard `FixColourMapEntries` (palettized reboot screens); true-color
/// sessions parse and skip it to stay aligned.
...
/// Server ping reply (149); the client reply shares the wire value (see alias).
